...
entities_string_test = '/entities_test.txt'
relations_string = '/relations.txt'
relations_string_test = '/relations_test.txt'
embeds_string = '/initEmbed.mat'
training_string = '/train.txt'
test_string = '/testIII.txt'
dev_string = '/dev.txt'
...
def load_entities_test(data_path=params.data_path):
  entities_file = open(data_path + entities_string_test)
  entities_list = entities_file.read().strip().split('\n')
  entities_file.close()
...
def load_relations_test(data_path=params.data_path):
  relations_file = open(data_path + relations_string_test)
  relations_list_test = relations_file.read().strip().split('\n')
  relations_file.close()

  return relations_list_test
